...
<main class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 mt-8">
    <section id="about" class="mb-16">
        ...
        <form class="max-w-md mx-auto" method="POST" action="<?= site_url('kelas/update/') ?><?= $kelas['id_kelas'] ?>">
            <?= csrf_field() ?>
            <h1 class="text-4xl font-semibold font-mono mb-5 text-gray-600">Edit Your Class Bro</h1>
            <div class="relative z-0 w-full mb-5 group">
                <input type="text" name="nama_kelas" id="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 focus:outline-none focus:ring-0 peer" placeholder=" " value="<?= $kelas['nama_kelas'] ?>" />
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="number" name="max" id="floating_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="<?= $kelas['max_kapasitas'] ?>" />
